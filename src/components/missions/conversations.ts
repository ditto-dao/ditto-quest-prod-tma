export const conversations: Record<number, string[]> = {
    ...
    1: [
        ...
        "Everything starts with materials — you'll need them to craft gear and progress. \n\nPress the menu at the top left and go to Farming. [1/4]",
        ...
        "Every time you farm, you gain materials and XP toward your Farming Level. \n\nTap Farm to begin — your activity will appear at the top. [3/4]",
        "You can only perform one activity at a time, so plan wisely! \n\nFarm your first Barkwood to complete the task and unlock crafting. [4/4]",
    ],

    2: [
        // Step 2 – Crafting
        "With your Barkwood in hand, it's time to craft. \n\nPress the menu and head to Crafting. [1/4]",
        "Pick between Rustfang, Barksting, or Twigwand — your first melee, ranged, or magic weapon. [2/4]",
        "These choices affect your Combat Stats: \n\n- Melee favors STR (Strength) \n\n- Ranged favors DEX (Dexterity) \n\n- Magic favors MAGIC [3/4]",
        "Equip what suits your style and complete the craft to move on. [4/4]",
    ],

    3: [
        // Step 3 – Combat
        "Let's test that gear in battle. \n\nGo to Inventory and equip the weapon you just crafted. [1/5]",
    ...
    5: [
        ...
        "Each slime has 8 core traits: body, pattern, color, eyes, and more. \n\nEach trait has 4 genes — 1 Dominant, 3 Hidden. [2/5]",
        "Dominant genes affect both stats and looks. \n\nHidden genes don't show — but can be inherited… or even mutate! [3/5]",
        "Pick two slimes, tap Breed, and review the probability table. \n\nYou'll see what traits the child might inherit. [4/5]",
